...
public class GraficadorClasico extends JPanel
{
    ...
    JPanel panelGrafico; //Aqui va la Zona grafica
    ...
    int Galto,Gancho;       //dimesiones de la zona de graficacion
    int    x0,y0;           //origen
    int    escalaX,escalaY;
...
class Biseccion extends Thread
{
    ...
    public void run()
    {
        ...
        if(p1*p2<=0){
            ...
            Mensaje.setText("esa funcion no sirve para este metodo");
...
+ " atanh() arcotangente hiperbolica atanh(x)*(3-x^(1/x))\n"
